...
background_image = Image.open("pexels-quang-nguyen-vinh-222549-2132250.jpg")  # Replace with the path to your image
...
def create_rainfall_impact_frame():
    ...
    bg_image = Image.open("pexels-enginakyurt-1435904.jpg")  # Replace with your image path
...
def create_optimal_fertilizer_frame():
    ...
    bg_image = Image.open("pexels-pixabay-325944.jpg")  # Replace with your image path
...
def create_state_based_yield_frame():
    ...
    bg_image = Image.open("pexels-blooddrainer-221016.jpg")  # Replace with your image path
    bg_image = bg_image.resize((1600, 1100), Image.Resampling.LANCZOS)
    bg_image = ImageTk.PhotoImage(bg_image)
